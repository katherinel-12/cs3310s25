...
# # Function to do Divide-and-Conquer matrix multiplication 
def divide_conquer_matrix_mult(matrixA, matrixB):
    n = len(matrixA) 
    ...
    # Step 1a: Divide Matrix A into 4 submatrices 
    A11, A12, A21, A22 = divide_matrix(matrixA) 
    
    # Step 1b: Divide Matrix B into 4 submatrices 
    B11, B12, B21, B22 = divide_matrix(matrixB) 
 
    # Step 2: Recursively multiply the 4 submatrices 
    matrixC11 = add_matrices(
        divide_conquer_matrix_mult(A11, B11), 
        divide_conquer_matrix_mult(A12, B21)
    )
    
    matrixC12 = add_matrices(
        divide_conquer_matrix_mult(A11, B12), 
        divide_conquer_matrix_mult(A12, B22)
    )
    
    matrixC21 = add_matrices(
        divide_conquer_matrix_mult(A21, B11), 
        divide_conquer_matrix_mult(A22, B21)
    )
    
    matrixC22 = add_matrices(
        divide_conquer_matrix_mult(A21, B12), 
        divide_conquer_matrix_mult(A22, B22)
    )
    
    # Step 3: Combine the results into the final matrix C 
...
while testing_n:
    ...
    if is_power_of_2(n):
        ...
        matrixC = divide_conquer_matrix_mult(matrixA, matrixB)
